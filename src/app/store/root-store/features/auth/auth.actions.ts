...
export const attemptAuthFailure = createAction('[Auth] Attempt Authentication Failure', props<AuthError>());
...
export const updateUserFailure = createAction('[Auth] Update User Failure', props<AuthError>());
